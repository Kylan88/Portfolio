...
import Loader from "./components/Loader"; // ← Nouveau composant
...
const App = () => {
  ...
  // Loader : disparaît après 2.5 secondes (ajuste si tu veux plus/moins long)
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* CONTENU PRINCIPAL - affiché seulement quand loading = false */}
      {!loading && (
